  ...
  useEffect(() => {
    if (agent?.latest_report?.raw_data) {
      console.log('Agent raw data structure:', {
        ...
        rawDataKeys: agent.latest_report.raw_data ? Object.keys(agent.latest_report.raw_data) : [],
    ...
    <AgentErrorBoundary>
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid w-full grid-cols-8">
          ...
          <TabsTrigger value="ai-insights" className="flex items-center space-x-1 text-xs">
            <Brain className="w-3 h-3" />
            <span>AI Insights</span>
          </TabsTrigger>
          <TabsTrigger value="hardware" className="flex items-center space-x-1 text-xs">
          ...
          <TabsTrigger value="processes" className="flex items-center space-x-1 text-xs">
            <Activity className="w-3 h-3" />
            <span>Processes</span>
          </TabsTrigger>
          <TabsTrigger value="software" className="flex items-center space-x-1 text-xs">
            <Package className="w-3 h-3" />
            <span>Software</span>
          </TabsTrigger>
          <TabsTrigger value="updates" className="flex items-center space-x-1 text-xs">
            <Download className="w-3 h-3" />
            <span>Updates</span>
          </TabsTrigger>
          <TabsTrigger value="configuration" className="flex items-center space-x-1 text-xs">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{systemInfo.networkStatus.uptime_percentage_24h.toFixed(1)}%</span>
                    </div>
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{systemInfo.performanceBaseline.history_days} days</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Collection Interval:</span>
                      <span className="font-medium">{Math.round(systemInfo.performanceBaseline.collection_interval_seconds / 60)}m</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Degradation Threshold:</span>
                      <span className="font-medium">{systemInfo.performanceBaseline.degradation_threshold_percent}%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Last Collection:</span>
                      <span className="font-medium text-xs">
                        {systemInfo.performanceBaseline.last_collection 
                          ? formatDistanceToNow(new Date(systemInfo.performanceBaseline.last_collection), { addSuffix: true })
                          : "Never"}
                      </span>
                    </div>
                  </div>
                  ...
                  {systemInfo.performanceBaseline.active_alerts > 0 && (
                    <div className="mt-4 p-3 border rounded-lg bg-red-50 border-red-200">
                      ...
                      <p className="text-red-700 text-xs">
                        {systemInfo.performanceBaseline.active_alerts} metric(s) showing degradation above {systemInfo.performanceBaseline.degradation_threshold_percent}% threshold
                      </p>
                    </div>
                  )}
                </CardContent>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="mt-4">
                      ...
                      {storage.slice(0, 3).map((drive, index) => {
                        ...
                        return (
                          <div key={index}>
                            {drive.device || drive.mountpoint || `Drive ${index + 1}`}: <span className={`${usage >= 85 ? "text-red-400" : usage >= 75 ? "text-yellow-400" : "text-green-400"}`}>{usage}% used</span>
                          </div>
                        );
                      })}
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Config Status:</span>
                      <Badge variant="default" className="bg-green-100 text-green-800">
                        Valid
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">API Connection:</span>
                      <Badge variant="default" className="bg-green-100 text-green-800">
                        Connected
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">SSL Verification:</span>
                    ...
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Heartbeat Interval:</span>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2">
                    <Shield className="w-5 h-5" />
                    <span>Command Security</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Command Filtering:</span>
                      <Badge variant="default" className="bg-green-100 text-green-800">
                        Active
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Allowed Patterns:</span>
                      <span className="font-medium">24 patterns</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Blocked Patterns:</span>
                      <span className="font-medium">32 patterns</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="mt-4 p-3 border rounded-lg bg-green-50 border-green-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-medium text-green-900 text-sm">Security Status</h4>
                    </div>
                    <p className="text-green-700 text-xs">
                      All command execution is filtered through security policies. Dangerous commands are automatically blocked.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-neutral-600">CPU Threshold:</span>
                      <span className="font-medium">80%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Memory Threshold:</span>
                      <span className="font-medium">80%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Disk Threshold:</span>
                      <span className="font-medium">90%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Load Check Interval:</span>
                      <span className="font-medium">30 seconds</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Max Concurrent Commands:</span>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">04:00</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span className="text-neutral-600">Next Window:</span>
                      <span className="font-medium text-xs">
                        {(() => {
                          const now = new Date();
                  ...
                  <div className="mt-4 p-3 border rounded-lg bg-blue-50 border-blue-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-medium text-blue-900 text-sm">Maintenance Mode</h4>
                    </div>
                    <p className="text-blue-700 text-xs">
                      During maintenance windows, system operations are deferred to minimize disruption.
                    </p>
                  </div>
                </CardContent>
              </Card>
