...
export const users = pgTable("users", {
  ...
  vip_user: boolean("vip_user").default(false),
  security_clearance: varchar("security_clearance", { length: 50 }),
  business_unit: varchar("business_unit", { length: 100 }),
  primary_device_id: uuid("primary_device_id"),
  backup_contact_email: varchar("backup_contact_email", { length: 255 }),
  shift_schedule: varchar("shift_schedule", { length: 100 }),
  escalation_manager_id: uuid("escalation_manager_id"),
